...
export default async function ProfileLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mx-auto flex min-h-dvh max-w-lg flex-col bg-latar">
      {/* Header style checkout: brand red + back + logo, NO bottom nav */}
      <header className="sticky top-0 z-20 bg-brand text-white">
        ...
        <div className="relative z-10 flex items-center justify-between px-4 pb-7 pt-12">
          <div className="flex items-center gap-3">
            <Link href="/akun" className="text-white transition-colors hover:text-white/80" aria-label="Kembali ke akun">
            ...
            <span className="text-sm font-extrabold tracking-tight">Perbarui Profil</span>
          </div>
